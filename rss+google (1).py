...
#         st.markdown("RSS + Google News + GDELT → Hybrid Search → FinBERT Sentiment")
# 
#     # SIDEBAR
#     with st.sidebar:
#         st.header("Settings")
# 
#         st.subheader("📰 Base RSS Data")
#         if st.button("Fetch RSS News"):
#             with st.spinner("Fetching base RSS articles…"):
...
#         )
# 
#         st.subheader("🌐 Extra Sources for this query")
...
#         with st.spinner("Pulling extra articles for this topic (GDELT / Google News)…"):
#             added = 0
#             if use_gdelt:
